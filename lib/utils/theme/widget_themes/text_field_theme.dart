...
class TTextFormFieldTheme {
  ...
  static InputDecorationTheme lightInputDecorationTheme = InputDecorationTheme(
    ...
    labelStyle: const TextStyle()
        .copyWith(fontSize: Sizes.fontSizeMd, color: TColors.black),
    hintStyle: const TextStyle()
        .copyWith(fontSize: Sizes.fontSizeSm, color: TColors.black),
  ...
  static InputDecorationTheme darkInputDecorationTheme = InputDecorationTheme(
    ...
    // constraints: const BoxConstraints.expand(height: TSizes.inputFieldHeight),
    labelStyle: const TextStyle()
        .copyWith(fontSize: Sizes.fontSizeMd, color: TColors.white),
    hintStyle: const TextStyle()
        .copyWith(fontSize: Sizes.fontSizeSm, color: TColors.white),
    floatingLabelStyle:
